...
void Model::SetColor(int Color)
{
	if (Color == 1)
	{
		MV1SetMaterialDifColor(m_modelHandle, 0, GetColorF(0.0f, 1.0f, 0.0f, 1.0f));	// 緑
	}
	if (Color == 2)
	{
		MV1SetMaterialDifColor(m_modelHandle, 0, GetColorF(1.0f, 0.0f, 0.0f, 1.0f));	// 赤
	}
	if (Color == 3)
	{
		MV1SetMaterialDifColor(m_modelHandle, 0, GetColorF(0.0f, 0.0f, 1.0f, 1.0f));	// 青
	}
}
